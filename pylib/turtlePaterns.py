...
def draw_note_sixteenth(note_position,note_height):
...
def draw_note_single_dot(note_position,note_height):
	"""Single note dot drawing."""
	1+1

def draw_note_double_dot(note_position,note_height):
